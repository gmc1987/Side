...
<html lang="en">
	...
	<script type="text/javascript" src="${ctx }/js/common/myjs/jquery-1.7.2.js"></script>
	<script type="text/javascript" src="j${ctx }/s/plugins/tab/js/framework.js"></script>
	...
	<script type="text/javascript" charset="utf-8" src="${ctx }/js/plugins/tab/js/tab.js"></script>
	</head>
