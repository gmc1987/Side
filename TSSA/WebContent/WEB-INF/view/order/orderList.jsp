...
Ext.onReady(function(){
	...
	/*产品优惠价*/
  	...
  	function orderTypeColumn(value,cellmeta,record,rowIndex,columnIndex,store){
  		var typeText = "";
  		switch (value){
  			case "orderMain":
	  			typeText = "主订单";
  	...
  	function orderStatusColumn(value,cellmeta,record,rowIndex,columnIndex,store){
  		var statusText = "";
  		switch (value){
  			case "0":
  				statusText = "待执行";
 	...
 	var colModel = new Ext.grid.ColumnModel([{
		...
		sortable:true,
		dataIndex:'orderType',
		renderer : orderTypeColumn
	},{
		header:'订单状态',
		width:80,
		sortable:true,
		dataIndex:'orderStatus',
		renderer : orderStatusColumn
	}]);  
