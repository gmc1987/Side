...
function openBusinessOrderFrame(){
	if(Ext.get("business_order_frame")){
		if(type == "04"){
			Ext.get("business_order_frame").dom.src = "${ctx}/restaurantOrder/toList.do?cacheflag="+new Date().getTime();
		} else if(type == "01"){
			Ext.get("business_order_frame").dom.src = "${ctx}/hotelOrder/toList.do?cacheflag="+new Date().getTime();
		}
