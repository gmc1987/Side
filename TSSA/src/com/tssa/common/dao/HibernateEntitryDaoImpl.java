...
//			}
	...
	@Override
	public <T> PageMode<T> findForPage(DetachedCriteriaTS<T> criteria,
			int pageNumber, int pageSize) {
		return findForPage(criteria, pageNumber, pageSize, null, null, false);
	}
	
	private <T> PageMode<T> findForPage(DetachedCriteriaTS<T> criteria, int pageNumber, int pageSize, CacheMode cacheMode,
			String cacheRegion, boolean cacheable){
